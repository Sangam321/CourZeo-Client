                    ...
                    <div className="order-1 lg:order-2 space-y-6">
                        <div>
                            ...
                            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                                Courzeo is a cutting-edge online learning platform that connects passionate educators
                        ...
                        <div>
                            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                                Our platform provides a seamless experience for both course creators and students,
                                offering advanced tools for content delivery, interactive learning, and progress tracking.
                                Whether you're looking to acquire new skills or share your expertise, Courzeo is your
                                gateway to unlimited learning opportunities.
                            </p>
                        </div>

                        <div className="flex flex-wrap gap-4">
                            <div className="bg-white dark:bg-gray-800 px-4 py-2 rounded-full shadow-sm">
                                <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Expert Instructors</span>
                            </div>
                            <div className="bg-white dark:bg-gray-800 px-4 py-2 rounded-full shadow-sm">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
                    <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md">
                        ...
                        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                            ...
                            and professional growth through innovative online learning experiences.
                        </p>
                    </div>
                    ...
                    <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md">
                        ...
                        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                            ...
                            community where knowledge knows no boundaries. We envision a future where learning
