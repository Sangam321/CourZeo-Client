...
const services = [
    {
        ...
        description:
            "Enable instructors to create, update, and publish high-quality online courses with video, quizzes, and resources.",
        gradient: "from-blue-500 to-blue-600",
    },
    {
        icon: <ShieldCheck size={40} className="text-white" />,
        title: "Secure Course Delivery",
        description:
    ...
    },
    {
        ...
        description:
            "Robust user management system for students and instructors, along with purchase history and analytics dashboard.",
