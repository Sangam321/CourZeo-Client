...
const faqs = [
    {
        question: "How can I publish a course on CourZeo?",
        answer:
            "After creating your course content, go to your instructor dashboard and click 'Publish'. Make sure all required fields like title, description, and video lectures are filled in before publishing.",
    },
    {
    ...
    },
    {
        ...
        answer:
            "Yes, each enrolled student gets a progress tracker for every course, allowing them to resume where they left off and view completion status.",
    },
    {
